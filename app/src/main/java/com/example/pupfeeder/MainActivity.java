...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        senha = (EditText) findViewById(R.id.editTextTextSenha);
        ...
        entrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if("admin".equals(usuario.getText().toString()) && "1234".equals(senha.getText().toString()))
                {
                    ...
                    Toast falhaAutenticacao = Toast.makeText(MainActivity.this,getResources().getString(R.string.activity_main_falha_autenticaçao), Toast.LENGTH_SHORT);
